# Chapter 1: Foundations of Global Politics

> **Source base:** IB Global Politics Guide (2024, first assessment 2026); Aakash's teacher's "GP Basics" pack; class slides on Framing Global Politics (1.1), Sovereignty (1.3), and Theory (1.6 — Realism and Liberalism).
>
> **Why this chapter matters.** Everything downstream — the three thematic studies, the IA, every essay you'll ever write — is built on Unit 1's four key concepts and the analytical habits (claim → evidence → link to concept → conclude) established here. If you're fluent in this chapter, the rest of GP becomes a matter of applying the same tools to new contexts.
>
> **How to use these notes.** Each section has (1) the theory or definition, (2) the standard IB framing, (3) two contrasting real-world examples from different regions, and (4) common examiner traps. The flashcards drill the definitions; these notes drill the *analytical habit*.

---

## Section 1.1 — What Global Politics Is (and Isn't)

**Global politics** is the study of political activity that transcends national boundaries — the interactions between states, non-state actors, international organisations, and civil society over issues of power, rights, development, and peace.

**Course aims** (memorise these — they show up embedded in mark schemes):

1. Explore and evaluate **power** in contemporary global politics.
2. Examine how **state and non-state actors** operate and interact within political systems.
3. Investigate contemporary political issues and challenges **from multiple perspectives**.
4. Develop a lifelong commitment to **active global citizenship** through collaboration and agency.

Notice what these aims tell you about the discipline: it's about **contested power**, **multiple actors** (not just states), **perspectives** (not right/wrong answers), and **action** (not detached observation).

### What GP is *not*

- Not international relations (IR) in the narrow academic sense. GP is broader — it includes civil society, NGOs, individuals, and sub-state actors, not just states.
- Not a "current affairs" course. You'll use current events as *evidence*, but the analytical apparatus (concepts, theories, stakeholder frames) is what earns marks.
- Not a discipline of certainties. As one head examiner put it: *"GP is not about black-and-white answers — it's full of grey areas."* Paper 2 rewards nuance, not conviction.

### The four ingredients of every GP argument

The whole course boils down to this four-step move — memorise it, use it in every paragraph:

1. **Write your claim.** A clear proposition, not a question.
2. **Support with evidence.** Real cases — place, date, actors. Not vague generalities.
3. **Link to GP key concepts or theories.** Don't just name-drop; *analyse* the case using the concept.
4. **Connect back** to your claim, question, or problem. A synthesis sentence.

Every paragraph in every essay follows this pattern. Every.
...
The core key concepts get applied through three thematic studies. Each has its own sub-concepts and, in Aakash's course, a designated case study.

| Theme | Sub-concepts | Case study |
|---|---|---|
| **Rights and Justice** | Rights, Justice, Liberty, Equality | North Korea |
| **Development and Sustainability** | Development, Sustainability, Poverty, Inequality | DRC (Democratic Republic of the Congo) |
| **Peace and Conflict** | Peace, Conflict, Violence, Non-violence | Libya |

You'll write two Paper 2 essays: one from Section A (a specific thematic question) and one from Section B (an integrating question that spans two or more themes). The three case studies are your ammunition — you'll be expected to develop each one enough that you can deploy it on demand.

### Quick previews (full treatment in later chapters)

**Rights and Justice — North Korea.** A regime where nearly every category of civil, political, and human rights is systematically denied. The 2014 UN Commission of Inquiry documented crimes against humanity: extrajudicial killings, enslavement, forced disappearance, and prolonged starvation. Illustrates the tension between state sovereignty and the "responsibility to protect" (R2P). Also useful for legitimacy, power, and interdependence discussions.

**Development and Sustainability — DRC.** One of the most resource-rich countries on Earth (cobalt, coltan, gold, timber) that ranks near the bottom of the HDI. Classic paradox: how can a country with so much natural wealth be so poor? Illustrates the "resource curse," neocolonial extraction, artisanal mining, and how global demand (EV batteries need cobalt) can reproduce local violence and inequality.

**Peace and Conflict — Libya.** The 2011 NATO-led intervention overthrew Gaddafi under a R2P mandate, but the aftermath produced state collapse, a decade-plus civil war, and a persistent split between rival governments. Illustrates the tension between humanitarian intervention and sovereignty, the difference between negative and positive peace, and the unintended consequences of "successful" military action.

---

## Section 1.4 — Levels of Analysis

Every political issue can be studied at multiple levels. Naming them explicitly in an essay demonstrates analytical rigour.

- **Individual level** — leaders, decision-makers, activists. Zelensky's leadership as a variable in the Russia-Ukraine war; Greta Thunberg's individual role in shifting climate discourse.
- **Sub-state / community level** — provinces, cities, tribes, ethnic groups. Kashmiri identity politics; Catalan independence movement; state-level climate policy in California vs Texas.
- **State level** — national governments and their institutions. Standard unit of analysis for realists.
- **Inter-state / international level** — alliances, treaties, IGOs. The G20; ASEAN; QUAD.
- **Global / systemic level** — the international system as a whole, its rules, its structural features. Global capitalism; the post-1945 liberal order.

Paper 2 essays often reward moving *between* levels. A strong essay on climate change might analyse the individual (activism), state (India's INDCs), international (Paris Agreement), and systemic (fossil-fuel capitalism) levels within a single argument.

---

## Section 1.5 — Theoretical Lenses

Different theories explain the same events differently. IB Global Politics wants you to recognise that political facts are always interpreted through *some* lens — and that different lenses illuminate different features.
...
**Core claim:** international politics is shaped by ideas, norms, identities, and shared meanings — not just material power or institutional design. What counts as "power" or "security" is socially constructed.

Key thinkers: Wendt ("Anarchy is what states make of it"), Finnemore, Katzenstein.

**Explains well:** why nuclear weapons are taboo but conventional weapons aren't; the diffusion of human rights norms; the emergence of R2P; why Germany's post-1945 identity constrains its foreign policy differently from France's.

**Blind spots:** hard to predict; less useful for material power dynamics.

### 1.5.4 Other lenses worth naming

- **Marxism / world systems theory** — global politics reflects capitalist class interests; core-periphery dynamics; DRC extraction fits this well.
- **Feminism** — gender is a category of political analysis; women are affected differently by conflict, migration, and development; the "personal is political."
- **Postcolonialism** — the legacy of colonialism still structures global inequality; challenges Western-centric assumptions in mainstream IR.

**Exam mechanics.** Paper 2 essays reward explicit use of *contrasting* lenses. Take a case — say India's non-alignment / strategic autonomy — and read it through realism (balancing between US and China), liberalism (using QUAD, BRICS, and SCO institutions), and constructivism (an identity rooted in Nehruvian non-alignment). Three lenses, one case, deep marks.

---

## Section 1.6 — Stakeholder Analysis Framework

Every GP question can be attacked by asking: *who cares about this issue, what do they want, and how are they framing it?*

The IB expects you to identify at least these categories:

| Actor type | Examples | Typical interests | Framing bias |
|---|---|---|---|
| **State actors** | Governments, militaries, security agencies | Sovereignty, security, national interest, re-election | Realist / statist |
| **Non-state actors (transnational)** | MNCs, terrorist groups, transnational advocacy networks | Profit, ideology, influence | Varies |
| **IGOs** | UN, WTO, IMF, World Bank, ICC | Institutional continuity, rule-based order | Liberal / institutionalist |
| **NGOs** | Amnesty, Human Rights Watch, Oxfam, MSF | Advocacy on specific rights/development issues | Norms-based / rights-based |
| **Civil society** | Trade unions, faith groups, media, protest movements | Voice, representation, sometimes direct participation | Varies |
| **Affected communities** | Refugees, indigenous groups, marginalised populations | Survival, recognition, redress | Grounded / experiential |

**A rule of thumb for Paper 2:** any essay that only discusses states is missing marks. Always bring in at least two categories beyond states.

**Also — actors don't have monolithic interests.** "India" has a foreign ministry that thinks realist, a NITI Aayog that thinks developmentalist, and civil society organisations that think rights-based. Break actors into sub-groups when it matters.

---

## Section 1.7 — Claims and Counterclaims: the Grey Areas Rule

The head examiner quote from Aakash's teacher's pack is worth memorising:

> *"GP is not about black-and-white answers — it's full of grey areas."*

**Claims and counterclaims don't need to be opposite ideas.** They can be different *perspectives on the same issue*. For example, an NGO and a government might both agree pollution is bad — but frame it entirely differently (rights violation vs cost-of-doing-business). Both are legitimate viewpoints.

**How to structure this:**

Different perspectives come from either:
- **Different stakeholders or actors** — governments, NGOs, IGOs, civil society.
- **Different political theories or lenses** — realism, liberalism, constructivism.

Explore multiple viewpoints in every essay to show depth. Even a case study that seems clearly "good" (say, R2P in Libya 2011) needs a counter-perspective (that it caused state collapse and civilian harm). Balance is not equivocation — it's analytical rigour.
...
|---|---|---|---|
| **Paper 1** — Source-based, 4 questions on the core unit | 1h 15min | 25 | 20% |
| **Paper 2** — Two essays: one thematic (Section A) + one integrating (Section B) | 1h 45min | 30 | 30% |
| **Engagement Project (IA)** — 2,000-word report + evidence of engagement | 35 hours | 30 | 30–50%* |

*SL weighting for IA is 20%; the exact papers weightings differ slightly. The above is the working outline from the GP Basics pack.

### Paper 1 — the four sub-questions

- **Q1 (3 marks, AO1):** Understand a source. Three simple sentences in ~5 minutes. Start with *"Source A states/emphasises/shows…"*
- **Q2 (4 marks, AO2):** Apply knowledge to a source. Explain a term or claim from a source. Two paragraphs — first summarises the source, second uses your own knowledge or a case study to support.
- **Q3 (6 marks, AO3):** Compare/contrast two sources. Running comparison: three separate paragraphs, each mentioning both sources with direct quotes. For "compare or contrast" questions, mix 1-2 similarities with 2-1 differences.
- **Q4 (12 marks, AO3):** Mini-essay. Define the key concept, thesis, 2 claims + 2 counterclaims (each grounded in a source AND your own case study), conclusion. Use *all four* sources.

### Paper 2 — the essay structure

**Introduction:**
- Mention and define the key concepts in the question.
- Briefly outline theories or levels of analysis you'll use.
- State your position clearly.
- Thesis should acknowledge alternative perspectives.

**Body paragraphs (minimum 2 claims + 2 counterclaims):**
- Two structures work: `1C → 1CC → 2C → 2CC` or `1 & 2C followed by 1 & 2CC`.
- Every paragraph = clear claim + case study (place, date, actors) + link to concept/theory + mini-conclusion tying to the question.

**Conclusion:**
- Summarise arguments; do NOT introduce new information; explicitly synthesise.

### Engagement Project (IA)

**2,000 words (SL). Six criteria, 30 marks total:**

| Criterion | What's assessed | Marks |
|---|---|---|
...
Report structure: introduction (topic, research question, engagement type, key concepts) → body paragraphs (claim → evidence from your engagement → secondary sources → concept link → mini-conclusion) → conclusion (no new info) → recommendation (evidence-based, realistic solutions).

---

## Section 1.9 — Common Exam Traps

1. **Name-dropping concepts without analysing them.** "This shows power" is not enough — *show how*.
2. **Only using state actors.** Every strong answer includes non-state actors (NGOs, MNCs, civil society, IGOs).
3. **Vague case studies.** "In Syria there was war" is worthless. "The 2013 Ghouta chemical attack, allegedly by the Assad regime, killed ~1,400 civilians and became the catalyst for US 'red-line' rhetoric" is a usable evidence point.
4. **Ignoring counter-perspectives.** Even if you think one side is right, GP rewards balance. Steel-man the opposition.
5. **Treating theories as right or wrong.** They're *lenses*, not verdicts. Realism explains great-power competition well and non-state actors poorly; liberalism the reverse.
6. **Conflating legitimacy, legality, and morality.** Something can be legal but illegitimate. Illegal but morally legitimate. Legitimate to one group and not another.
7. **Assuming sovereignty is either "intact" or "eroded."** It's a spectrum, and different dimensions (economic, political, cultural, digital) erode at different rates.
8. **Writing creatively.** GP writing is *clear, factual, and academic*. No similes, metaphors, or literary flourishes. Save them for English.
9. **Forgetting to include a "mini-conclusion" per paragraph.** Every body paragraph ends with a sentence tying back to the question.
10. **Losing marks on definitions.** The intro should always define key concepts from the question. Doing this well signals command-term compliance.

---

## Section 1.10 — Exam-Ready Definitions

- **Global politics** — the study of political activity that transcends national boundaries, involving state and non-state actors on issues of power, rights, development, and peace.
- **Power** — the ability to affect change; contested, relational, and taking hard, soft, smart, and structural forms.
- **Hard power** — coercion via military or economic force.
- **Soft power** — attraction via culture, ideology, and legitimate foreign policy.
- **Smart power** — the deliberate combination of hard and soft power.
- **Structural power** — control over the rules of the international system, not just outcomes.
- **Sovereignty** — a state's independence, territorial control, and self-government; both internal (supreme authority within) and external (recognition by other states).
- **Legitimacy** — the acceptability of an actor or action to a relevant population; can be democratic, traditional, charismatic, performance-based, or internationally recognised.
- **Interdependence** — the mutual reliance between actors on resources, systems, or arrangements; increased by globalisation and often asymmetric.
- **Sensitivity** (interdependence) — how quickly change in one country produces costly effects in another.
- **Vulnerability** (interdependence) — how costly it is to adjust to those changes.
- **Realism** — theory that the international system is anarchic; states pursue national interest defined as security and power.
- **Liberalism** — theory that cooperation is possible via institutions, interdependence, and shared democratic values.
- **Constructivism** — theory that international politics is shaped by ideas, norms, identities, and socially constructed meanings.
- **Levels of analysis** — individual, sub-state, state, international, global/systemic.
- **State actor** — a national government or its formal institutions.
- **Non-state actor** — any political actor that is not a state; includes NGOs, MNCs, IGOs, civil society, and armed non-state groups.
- **IGO** — inter-governmental organisation whose members are states (UN, WTO, IMF).
- **NGO** — non-governmental organisation, typically issue-focused and privately funded (Amnesty, MSF, HRW).
- **R2P (Responsibility to Protect)** — the doctrine that the international community has a responsibility to intervene when a state fails to protect its own population from mass atrocity crimes.
- **Positive peace** — the presence of justice, equity, and the conditions for sustained non-violence (Galtung).
- **Negative peace** — simply the absence of overt violence or war (Galtung).

---

## Section 1.11 — Diagnostic Prompts to Test Yourself

Before moving to the thematic chapters, you should be able to:

1. Define all four core key concepts without notes and give one contrasting example from a different region for each.
2. Distinguish sensitivity from vulnerability in interdependence with an Indian example.
3. Explain the differences between realism, liberalism, and constructivism using the same case (e.g., Russia-Ukraine) read through each lens.
4. Identify at least six actors involved in *any* global issue (state, non-state, IGO, NGO, MNC, affected community).
5. Write a single body paragraph in the four-step GP structure (claim → evidence → concept → conclusion) on any current news story.
6. Recite the six IA criteria and what each measures.

If you can't do all six, re-read the relevant sections.
...
1. IB Diploma Programme Global Politics Guide, First Assessment 2026 (International Baccalaureate Organization).
2. Aakash's teacher's **GP Basics** compilation (17-page structured summary of aims, core concepts, thematic studies, and assessment).
3. Heywood, A. (2014, 2nd ed.). *Global Politics.* Palgrave Macmillan — standard IB Global Politics reference.
4. Grieco, J., Ikenberry, G. J. and Mastanduno, M. (2019, 2nd ed.). *Introduction to International Relations: Enduring Questions and Contemporary Perspectives.* Red Globe Press.
5. Nye, J. (2004). *Soft Power: The Means to Success in World Politics.* PublicAffairs — foundational for the hard/soft/smart power taxonomy.
6. Keohane, R. and Nye, J. (1977, updated editions). *Power and Interdependence.* Longman — sensitivity vs vulnerability distinction.
7. Mearsheimer, J. (2001). *The Tragedy of Great Power Politics.* Norton — offensive realism.
8. Wendt, A. (1992). "Anarchy is what states make of it." *International Organization*, 46(2). Constructivism's founding article.
9. Galtung, J. (1969). "Violence, Peace, and Peace Research." *Journal of Peace Research*, 6(3) — positive vs negative peace.
10. UN Commission of Inquiry Report on Human Rights in the DPRK (2014) — case study reference for the rights and justice thematic.
11. UN Security Council Resolution 1973 (2011) — the Libya R2P authorisation.
12. World Bank / UNDP Human Development Reports — for HDI, poverty, and inequality data used across the development thematic.
13. Freedom House annual reports — for legitimacy and democratic-index examples.
14. Fund for Peace / Fragile States Index — for sovereignty erosion examples.
15. Recent scholarship: articles from *Foreign Affairs*, *Foreign Policy*, and *International Security* used for current examples (Russia-Ukraine, US-China rivalry, DRC cobalt trade).
